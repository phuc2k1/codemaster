 ...
 ************************************************************************************/
#define	NODE_ID_DEFAULT		0x02
#define CO_DEVICE			mc.base		//<< canopen object
...
/* */
#define CO_CF_1008_DEVICE_NAME	"SELEX_MCL"
...
#define CO_CF_100500_SYNC_GEN							CO_SYNC_NOT_GEN		//<< PMU/BSS_MASTER: Set CO_SYNC_GEN
...
#define CO_CF_103200_SDO_CLI_SYNC_TRANS_TYPE			(3)				//<< Set according to synchronous scheduled
																		//   Set 0 if you want disable sync mode, switch to always communication mode
#define CO_CF_103201_SDO_CLI_SYNC_MASK_REGISTER			(0x00000FFF)	//<< Set according to synchronous scheduled, default: 0x00000000

/* Synchronous TPDOs */
#define CO_CF_180000_TPDO1_ENABLE						CO_PDO_VALID	//<< Set CO_PDO_VALID if used, otherwise, set CO_PDO_NOT_VALID
#define CO_CF_180001_TPDO1_TRANS_TYPE					(23)			//<< Set according to synchronous scheduled
#define CO_CF_180005_TPDO1_SYNC_MASK_REGISTER			(0x00000FFF)	//<< Set according to synchronous scheduled, default: 0x00000000

#define CO_CF_180100_TPDO2_ENABLE						CO_PDO_VALID	//<< Set CO_PDO_VALID if used, otherwise, set CO_PDO_NOT_VALID
#define CO_CF_180101_TPDO2_TRANS_TYPE					(24)			//<< Set according to synchronous scheduled
#define CO_CF_180105_TPDO2_SYNC_MASK_REGISTER			(0x00000001)	//<< Set according to synchronous scheduled, default: 0x00000000

#define CO_CF_180200_TPDO3_ENABLE						CO_PDO_VALID	//<< Set CO_PDO_VALID if used, otherwise, set CO_PDO_NOT_VALID
#define CO_CF_180201_TPDO3_TRANS_TYPE					(25)			//<< Set according to synchronous scheduled
#define CO_CF_180205_TPDO3_SYNC_MASK_REGISTER			(0x00000001)	//<< Set according to synchronous scheduled, default: 0x00000000

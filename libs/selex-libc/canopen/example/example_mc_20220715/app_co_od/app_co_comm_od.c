...
//    },
	...
	.x1A0x_tpdo_map_para[0] = {			//<< EDITABLE:
		.object_number	= 0x03,					//<< number of mapped application objects in PDO
		.app_object[0]	= {.index = 0x30F7, .sub_index = 0x00, .len = 1},	//<< application object 1st
		.app_object[1]	= {.index = 0x30F7, .sub_index = 0x01, .len = 2},	//<< application object 2st
		.app_object[2]	= {.index = 0x30F7, .sub_index = 0x02, .len = 5},	//<< application object 3st
